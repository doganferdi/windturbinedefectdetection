...
lgraph = removeLayers(lgraph, {'Logits','Logits_softmax','ClassificationLayer_Logits'});
            newLayers = [
                     fullyConnectedLayer(numClassesPlusBackground,'Name','Logits','WeightLearnRateFactor',10,'BiasLearnRateFactor', 10)
            ...
            % yapılan değişikliklerle grafikleri kontrol et
                lgraph = connectLayers(lgraph,'global_average_pooling2d_1','Logits');
...
save ('C:\Program Files\MATLAB\R2024b\toolbox\nnet\cnn\zeliharuzgarturbini\sonuc_5sinifli_MobilNetV2_v1.mat','-v7.3');
