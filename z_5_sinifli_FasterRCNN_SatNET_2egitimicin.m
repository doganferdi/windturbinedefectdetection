...
load ('C:\Program Files\MATLAB\R2024b\toolbox\nnet\cnn\zeliharuzgarturbini\SatNET_ruzgarturbini_icin.mat');
load ('C:\Program Files\MATLAB\R2024b\toolbox\nnet\cnn\zeliharuzgarturbini\sonuc_5sinifli_SATNETvs2.mat');
%%
...
% lgraph =net_1;
% lgraph = dlnetwork(net1_sonkatmanli.Layers,Initialize=false);
...
% 
% newLayers = [
%     fullyConnectedLayer(numClassesPlusBackground, 'Name', 'fc1000')
%     softmaxLayer('Name', 'prob')
%     classificationLayer('Name', 'ClassificationLayer_predictions')
%     ];
% lgraph = addLayers(lgraph, newLayers);
% lgraph = connectLayers(lgraph, 'avgpool2d', 'fc1000');
   % plot(lgraph)
...
save ('C:\Program Files\MATLAB\R2024b\toolbox\nnet\cnn\zeliharuzgarturbini\sonuc_5sinifli_SATNETvs3.mat','-v7.3');
...
results = detect(detector,imdsTest,'MinibatchSize',2,Threshold=0.5);
